<template>
    <div class="footer-main">
        ...
        <div class="footer-main__wrapper">
            ...
            <ul class="footer-list">
                <li class="footer-list__item download">
        ...
        <div class="footer-main__wrapper">
            ...
            <ul class="footer-list social-links">
                <li class="footer-list__item">
                    <a href="/">
                        <svg data-v-647df61d="" width="32" height="32" viewBox="0 0 48 48" fill="#000" xmlns="http://www.w3.org/2000/svg" class="ui-icon ">
                ...
                <li class="footer-list__item">
                    <a href="/">
                        <svg data-v-647df61d="" width="32" height="32" viewBox="0 0 44 44" fill="#000" xmlns="http://www.w3.org/2000/svg" class="ui-icon ">
